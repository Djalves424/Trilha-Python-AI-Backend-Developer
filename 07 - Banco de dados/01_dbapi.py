...
def inserir_registro(conexao, cursor, nome, email):
    ...
    # inserir_registro(conexao, cursor, "Diego de Jesus", "djalves424@gmail.com")
...
def atualizar_registro(conexao, cursor, nome, email, id):
    ...
    # atualizar_registro(conexao, cursor, "Diego de Jesus", "djalves424@gmail.com", 3)
